...
import ownerCommissionInvoiceRoutes from "./routes/ownerCommissionInvoices.js";
import ownerCommissionRequestRoutes from "./routes/ownerCommissionRequests.js";
import ownerPlatformPlRoutes from "./routes/ownerPlatformPl.js";
import ownerFiledPeriodRoutes from "./routes/ownerFiledPeriods.js";
...
app.use("/api/app/owner/commission-invoices", ownerCommissionInvoiceRoutes);
app.use("/api/app/owner/commission-requests", ownerCommissionRequestRoutes);
app.use("/api/app/owner/platform", ownerPlatformPlRoutes);
app.use("/api/app/owner/filed-periods", ownerFiledPeriodRoutes);
...
app.use("/api/app/seller/complaints", sellerComplaintRoutes);
